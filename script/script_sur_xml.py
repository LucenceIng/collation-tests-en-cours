...
#sur laisses mais ne fonctionne pas ; pris ici :http://collatex.obdurodon.org/xml-json-conversion.xhtml
class Witness:
    ...
    def maxId(self):
        return max(self.ids())
    def lById(self,id):
   #word-tokenized <l> of a witness by @id not
    #called directly;
    #used by words(), below
        self.id = str(id)
...
class WitnessSet:
    """An instance of WitnessSet is the set of witnesses being collated    In these examples, the witnesses are individual <l> elements, not entire mss    """
...
def main():
    witnessA = """    <lg wit="A">        <l id="8" n="8">Ki maint <abbrev>et</abbrev> el pere et el fis</l>        <l id="9" n="9">Ki ma doune soie merci</l>    </lg>    """
    witnessB = """    <lg wit="B">        <l id="8" n="8">Q<abbrev>ui</abbrev> mai<abbrev>n</abbrev>t <abbrev>et</abbrev> el pere <abbrev>et</abbrev> el fis</l>        <l id="9" n="9">Q<abbrev>ui</abbrev> ma done soie merci</l>    </lg>    """
    ...
    # Uncomment the following line to see the JSON input to CollateX        # print(json.dumps(block,indent=2))
